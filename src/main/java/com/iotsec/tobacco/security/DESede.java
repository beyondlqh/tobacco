...
public class DESede {
	public static final DESede desede = new DESede();
	public static Key finalKey;
	public static Cipher cipher;

	private DESede() {
		byte[] key = new byte[] { 0x12, 0x34, 0x56, 0x78, 0x78, 0x78, 0x78,
				0x78, 0x12, 0x34, 0x56, 0x78, 0x78, 0x78, 0x78, 0x78, 0x12,
				0x34, 0x56, 0x78, 0x78, 0x78, 0x78, 0x77 };
		KeySpec keySpec;
		try {
			keySpec = new DESedeKeySpec(key);
			finalKey = SecretKeyFactory.getInstance("DESede").generateSecret(
					keySpec);
